...
function Opening() {
  return (
    <section id="Home" className="bg-titleCode bg-cover bg-left pb-10 ">
      <div className="text-center p-5 lg:p-20">
        <h2 className="text-5xl font-medium py-8 text-teal-300 drop-shadow-[0_3.2px_3.2px_rgba(0,0,0,1.0)]">Hi, I&apos;m Joseph Soto</h2>
        <h3 className="text-3xl font-medium py-2 text-white drop-shadow-[0_3.2px_3.2px_rgba(0,0,0,1.0)]">I build things for the web.</h3>
        <h3 className="text-md py-5 leading-8 text-white drop-shadow-[0_3.2px_3.2px_rgba(0,0,0,1.0)] mb-10 lg:text-xl">I&apos;m a software engineer based in Mesa, AZ specializing in building (and occasionally designing) exceptional websites, applications, and everything in between.</h3>
      ...
      <div className="text-5xl flex pt-10 justify-center gap-16 text-white drop-shadow-[0_3.2px_3.2px_rgba(0,0,0,1.0)] lg:pt-0">
        <a
